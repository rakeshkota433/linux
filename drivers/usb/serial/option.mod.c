...
__attribute__((section("__versions"))) = {
	...
	{ 0x30d0d947, __VMLINUX_SYMBOL_STR(usb_wwan_dtr_rts) },
	{ 0x889b4c74, __VMLINUX_SYMBOL_STR(usb_wwan_tiocmset) },
	{ 0x2961ab1c, __VMLINUX_SYMBOL_STR(usb_wwan_tiocmget) },
	{ 0x41359a30, __VMLINUX_SYMBOL_STR(usb_wwan_chars_in_buffer) },
	{ 0xbec91eaa, __VMLINUX_SYMBOL_STR(usb_wwan_ioctl) },
	{ 0xf9e45b4b, __VMLINUX_SYMBOL_STR(usb_wwan_write_room) },
	{ 0xe856107c, __VMLINUX_SYMBOL_STR(usb_wwan_write) },
	{ 0x183baae9, __VMLINUX_SYMBOL_STR(usb_wwan_close) },
	{ 0x973de1d, __VMLINUX_SYMBOL_STR(usb_wwan_open) },
	{ 0x962b29f5, __VMLINUX_SYMBOL_STR(usb_wwan_resume) },
	{ 0xbc4c7d13, __VMLINUX_SYMBOL_STR(usb_wwan_suspend) },
	{ 0x7e17b4ca, __VMLINUX_SYMBOL_STR(usb_wwan_port_remove) },
	{ 0x27f9ea03, __VMLINUX_SYMBOL_STR(usb_wwan_port_probe) },
...
MODULE_ALIAS("usb:v1199p68C0d*dc*dsc*dp*icFFisc*ip*in*");
MODULE_ALIAS("usb:v1199p9041d*dc*dsc*dp*icFFisc*ip*in*");
...
MODULE_INFO(srcversion, "13FB4E265E6798C7A2FD31B");
