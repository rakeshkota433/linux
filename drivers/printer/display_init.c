...
#define STB1   	GPIO_TO_PIN(4, 21) //MX6UL_PAD_CSI_DATA00__GPIO4_IO21
#define STB2   	GPIO_TO_PIN(4, 22) //MX6UL_PAD_CSI_DATA01__GPIO4_IO22
#define STB3   	GPIO_TO_PIN(4, 23) //MX6UL_PAD_CSI_DATA02__GPIO4_IO23
#define STB4   	GPIO_TO_PIN(4, 24) //MX6UL_PAD_CSI_DATA03__GPIO4_IO24
#define STB5   	GPIO_TO_PIN(4, 26) //MX6UL_PAD_CSI_DATA05__GPIO4_IO26
#define STB6   	GPIO_TO_PIN(4, 13) //MX6UL_PAD_NAND_CE0_B__GPIO4_IO13 

//STEPPER MOTOR FOR DRV8833 BY RAKESH ANALOGICS
#define ENA1     GPIO_TO_PIN(2, 11) //MX6UL_PAD_ENET2_TX_DATA0__GPIO2_IO11
#define ENA2     GPIO_TO_PIN(2, 8) //MX6UL_PAD_ENET2_RX_DATA0__GPIO2_IO08
#define IN1      GPIO_TO_PIN(2, 9) //MX6UL_PAD_ENET2_RX_DATA1__GPIO2_IO09
#define IN2      GPIO_TO_PIN(2, 10) //MX6UL_PAD_ENET2_RX_EN__GPIO2_IO10

//PRINTER CONTROL PINS ADDED BY RAKESH ANALOGICS
#define PRN_PW  GPIO_TO_PIN(1,  0) //MX6UL_PAD_GPIO1_IO00__GPIO1_IO00
#define LAT  	GPIO_TO_PIN(4,  14) //MX6UL_PAD_NAND_CE1_B__GPIO4_IO14
...
static int display_remove(struct spi_device *spi)
{
...
static const struct of_device_id printer_match_table[] = {
		{.compatible = "Analogics,display", },
		{ },
};

static struct spi_driver displayDriver = {
...
static int __init thprn_init(void)
{
	...
	ret=spi_register_driver(&displayDriver);
        ret=-1;
...
{
        spi_unregister_driver(&displayDriver);
